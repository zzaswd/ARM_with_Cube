...
void us_delay(uint16_t delay_time){
	TIM3->CNT = 0;
...
int main(void)
{
  ...
  MX_TIM3_Init();
  /* USER CODE BEGIN 2 */
  //uint8_t tx_data[10] = {0xFF,0xFF,0xFD,0x00,0x01,0x03,0x00,0x01,0x19,0x4E};
  uint8_t CRC_H;
  uint8_t CRC_L;

  //unsigned char TxPacket[]= {0xFF,0xFF,0xFD,0x00,0x01,0x07,0x00,0x02,0x46,0x00,0x01,0x00,0x00,0x00};
  //unsigned char TxPacket[]= {0xFF,0xFF,0xFD,0x00,0x01,0x03,0x00,0x01,0x19,0x4E};
  //unsigned char TxPacket[]= {0xFF,0xFF,0xFD,0x00,0x01,0x09,0x00,0x03,0x16,0x01,0x20,0x00,0x00,0x00,0x00,0x00};
  //unsigned char TxPacket[]= {0xFF,0xFF,0xFD,0x00,0x01,0x09,0x00,0x03,0x74,0x00,0x20,0x00,0x00,0x00,0x00,0x00};
  //unsigned char TxPacket[]= {0xFF,0xFF,0xFD,0x00,0x01,0x06,0x00,0x03,0x0B,0x00,0x03,0x00,0x00}; // Operating mode length : 13
